            ...
            <table id="example" class="min-w-full border-collapse border border-gray-200 ">
                <thead class="bg-amber-300 text-black">
                    <tr>
                        ...
                        <th class="py-2 px-4 border-2 border-blue-500">วิธีที่ได้มา</th>
                ...
                <tbody class="bg-white text-gray-700">
                    @foreach ($dataequipment as $item)
                        <tr>
                            ...
                            <td class="py-2 px-4 border-2 border-blue-500">{{ $item->acquisition_method }}</td>
                            ...
                            <td class="py-2 px-4 border-2 border-blue-500"> <a
                                    href="{{ route('generate-pdf.GeneratePDFEquipmentone', ['id' => $item->equipments_code]) }}"
